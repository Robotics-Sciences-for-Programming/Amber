...
#include "amber_b1_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Mode_Request_type_support_symbol_names_t _Mode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amber_b1_interfaces, srv, Mode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, amber_b1_interfaces, srv, Mode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_amber_b1_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, amber_b1_interfaces, srv, Mode_Request)() {
  return &::amber_b1_interfaces::srv::rosidl_typesupport_c::Mode_Request_message_type_support_handle;
}
...
static const _Mode_Response_type_support_symbol_names_t _Mode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amber_b1_interfaces, srv, Mode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, amber_b1_interfaces, srv, Mode_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_amber_b1_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, amber_b1_interfaces, srv, Mode_Response)() {
  return &::amber_b1_interfaces::srv::rosidl_typesupport_c::Mode_Response_message_type_support_handle;
}
...
static const _Mode_type_support_symbol_names_t _Mode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amber_b1_interfaces, srv, Mode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, amber_b1_interfaces, srv, Mode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, amber_b1_interfaces, srv, Mode)() {
  return &::amber_b1_interfaces::srv::rosidl_typesupport_c::Mode_service_type_support_handle;
}
